...
def convert_files(root_folder_src, src_extension, dst_extension, converter_cmd):
    """
    The Requirement to run this script is to install Calibre eBook management software
    :param root_folder_src: where your documents are stored
    ...
    for dir_path, dirs, files in os.walk(root_folder_src):
